...
public final class MCURegistrarLugar
    ...
    public ActionForward procesarRegistroLugar(
        ...
        Lugar lugar = new Lugar(forma.getNombre(),forma.getDescripcion(),forma.getPoblacion(),forma.getCoordenadas(),forma.getEstado());
        ...
        switch (resultado) {
            ...
            default:
                log.warn("ManejadorLugares.crearLugar regresó reultado inesperado");
                errores.add(ActionMessages.GLOBAL_MESSAGE,
                            new ActionMessage("errors.infraestructura"));
                saveErrors(request, errores);
                return (mapping.getInputForward());
